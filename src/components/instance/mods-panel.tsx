    ...
    <Tooltip.Provider>
      <Card.Root>
        ...
        <Card.Body className="flex flex-col gap-3">
          ...
          {!loaderInstalled && (
            <div className="rounded-md border border-yellow/25 bg-yellow-muted px-3 py-2 text-[11.5px] text-text">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-2.5 rounded-lg border border-border bg-card px-5 py-10 text-center">
            ...
            <div className="overflow-hidden rounded-lg border border-border">
              <AnimatePresence initial={false}>
                {mods.map((mod, index) => (
                  ...
                  >
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded icon-box--purple">
                      <Puzzle size={14} />
                    </div>
